  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in">
      <div className="flex items-center space-x-4">
        <Link to="/manager/sales" className="text-surface-400 hover:text-slate-200 transition-colors">
          <ArrowLeft size={24} />
        </Link>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-6 border-t border-surface-700/50 gap-4">
            ...
            <div className="flex space-x-3 w-full sm:w-auto">
              <Link to="/manager/sales" className="btn-outline flex-1 sm:flex-none text-center">Cancel</Link>
